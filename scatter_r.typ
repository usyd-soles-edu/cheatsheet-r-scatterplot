...
#quote(block: true)[
This work is licensed under a #link("https://creativecommons.org/licenses/by/4.0/")[Creative Commons Attribution 4.0 International License];.
]
...
= Data
<data>
For this cheatsheet we will use part of the possums dataset used in #link("https://www.sydney.edu.au/units/BIOL2022")[BIOL2022] labs. Two numerical variables are available: `ExpBLUP` and `AactiveTBLUP`. The data is available in the file `possums-blup.csv`.
...
#box(image("scatter_r_files/figure-typst/unnamed-chunk-2-1.svg"))
